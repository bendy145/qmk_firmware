 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | escap| wgui | Alt  | lower |spc | spc | shift   |Raise | Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_preonic_grid(
  ...
  KC_ESC,   KC_LGUI, KC_LALT, LOWER,   KC_SPC,  KC_SPC,  KC_RSFT, RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
[_COLEMAK] = LAYOUT_preonic_grid(
  ...
  BACKLIT, KC_LGUI, KC_LALT, LOWER,   KC_SPC,  KC_SPC,  KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
